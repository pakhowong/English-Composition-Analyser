...
begin
     ...
     Label7.Caption := 'Progress: ' + IntToStr(ProgressBar1.Position) + '%';   //Reset.
     hasComment := FALSE;   //Reset.
     isFinished_WW := FALSE;   //Reset.
     isFinished_Cap := FALSE;   //Reset.
     isFinished_Comment := FALSE;   //Reset.
     isFinished_Grade := FALSE;   //Reset.
     words := 0;
     NumOfPara := 0;
